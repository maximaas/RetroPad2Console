...
#define  USB_CFG_VENDOR_ID       0x5E, 0x04 /* = 0x16c0 = 5824 = voti.nl */
 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0x02, 0x02 /* = 0x05dc = 1500 */
...
#define USB_CFG_VENDOR_NAME		'w', 'w', 'w', '.', 'b', 'r', 'u', 'n', 'o', 'f', 'r', 'e', 'i', 't', 'a', 's', '.', 'c', 'o', 'm'
 ...
 * details.
 */
//#define USB_CFG_DEVICE_NAME     'V', 'I', 'R', 'T', 'U', 'A', ' ', 'S', 'T', 'I', 'C', 'K', ' ', 'H', 'i', 'g', 'h', ' ', 'G', 'r', 'a', 'd', 'e'
//#define USB_CFG_DEVICE_NAME_LEN 23
#define USB_CFG_DEVICE_NAME		'U', 'S', 'B', ' ', 'R', 'e', 't', 'r', 'o', 'P', 'a', 'd', ' ', 'A', 'd', 'a', 'p', 't', 'e', 'r'
