...
void xbox_send_pad_state() {
	...
	while (!usbInterruptIsReady3()) {
		...
		//xbox console takes less than 40000 times polling for usb communication.
		//By setting a 50000 threshold to determine if the connected console is a xbox.
		if (i == 50000)
			return;
		i++;
	}
